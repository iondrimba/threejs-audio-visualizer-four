    ...
    value: function addTilesRow(tiles) {
      ...
      for (var col = 0; col < cols; col++) {
        ...
        var _loop = function _loop(row) {
          ...
          var plane = _this5.createObj(_this5.objectsColor);
          ...
          plane.rotateX(_this5.radians(90));

          _this5.groupTiles.add(plane);

          _gsap.TweenMax.delayedCall(0.1 * index, function () {
            _gsap.TweenMax.to(plane.children[0].material, .3, {
              opacity: 1,
              ease: _gsap.Power2.easeOut
            });
          });
      ...
      if (this.playing) {
        ...
        for (var i = 0; i < this.rowTiles.length; i++) {
          for (var j = 0; j < this.rowTiles[i].length; j++) {
            var freq = this.frequencyData[index];
            var scale = freq / 50 <= 0 ? 0.01 : freq / 50;

            _gsap.TweenMax.to(this.rowTiles[i][j].scale, .2, {
    ...
    value: function addEventListener() {
      ...
      document.body.addEventListener('keyup', function (evt) {
        if (evt.keyCode === 32 || evt.code === 'Space') {
          _this8.playing ? _this8.pause() : _this8.play();
        }
      });
    }
  }, {
