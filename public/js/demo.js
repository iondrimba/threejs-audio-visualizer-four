...
var App = function () {
  ...
  _createClass(App, [{
    ...
    value: function playSound(file) {
      ...
      setTimeout(function () {
        _this5.audioElement.src = file;
        _this5.audioElement.load();
        _this5.audioElement.play();
    ...
    value: function addSoundControls() {
      ...
      this.btnPlay.addEventListener('click', function () {
        ...
        _this6.btnPlay.classList.remove('control-show');
        _this6.btnPause.classList.add('control-show');
      });

      this.btnPause.addEventListener('click', function () {
        _this6.audioElement.pause();
        _this6.btnPause.classList.remove('control-show');
        _this6.btnPlay.classList.add('control-show');
      });
    }
  }, {
    key: 'createScene',
